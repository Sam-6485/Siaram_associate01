...
export const getGetLeadsSummaryQueryKey = () => {
  return [`/api/leads/summary`] as const;
};

export const getGetLeadsSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getLeadsSummary>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getLeadsSummary>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLeadsSummary>>> = ({
    signal,
  }) => getLeadsSummary({ signal, ...requestOptions });
...
export type GetLeadsSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLeadsSummary>>
>;
...
export function useGetLeadsSummary<
  TData = Awaited<ReturnType<typeof getLeadsSummary>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
